...
*(We are middle class—we don’t even have a washing machine.)*

Economists have debated the best way to define the middle class—with approaches using income-based thresholds, socio-cultural factors, or even the nature of employment. Among the many approaches, the one I find most interesting is perhaps the simplest—to just ask the people directly.
...
![Figure 1: Middle Class Self-Identification, by Income and Education](/images/post_images/blog_middle_class/fig1_middle_class_by_income.png "Bar plot - Middle Class Self-Identification, by Income and Education"){: width="500" style="display: block; margin: 0 auto"}
